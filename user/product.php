        ...
        <div>
            <section class="py-12 px-6">
                <div class="max-w-7xl mx-auto">
                    <h2 class="relative text-3xl font-extrabold text-center text-gray-800 mb-8 p-4 border-4 border-dashed border-blue-500 rounded-xl shadow-md bg-gradient-to-r from-blue-200 via-white to-blue-100">
                        ...
                        while ($product = $result->fetch_assoc()): ?>
                            ...
                            <div class="bg-white shadow-md rounded-lg overflow-hidden transform hover:scale-105 transition duration-300">
                                <div class="relative">
                                    ...
                                    <span class="absolute top-4 left-4 bg-cyan-500 text-white py-1 px-3 rounded-full text-sm">
                                ...
                                <div class="bg-gradient-to-r from-blue-100 via-white-200 to-blue-300 p-6">
                                    ...
                                    <button class="mt-6 w-full bg-cyan-500 text-white py-2 px-4 rounded-lg hover:shadow-lg transition">
                                        Add to Cart
                                    </button>
                                </div>
                            </div>
